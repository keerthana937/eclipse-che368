...
RUN pip install --upgrade pip && \
    pip install --no-cache-dir notebook numpy pandas scipy scikit-learn statsmodels matplotlib && \
	pip install --no-cache-dir ipython sklearn regex Werkzeug Flask Flask-Cors &&\
	pip install --n0-cache-dir Keras tensorflow tensorflow-estimator
